...
struct LoginScreen_Previews: PreviewProvider {
    static var previews: some View {
        LoginScreen().environmentObject(AppData())
    }
}
            ...
            NavigationView {
                VStack {
                    ...
                    VStack {
                        ...
                        NavigationLink(destination: HomeScreen(), isActive: self.$appData.isLoggedIn) {
                            Button(action: {
                                self.appData.isLoggedIn = authenticator.login(username: username, password: password, moc: moc, appData: appData)
                            }) {
                                Text("Sign In")
                            }
                        }
